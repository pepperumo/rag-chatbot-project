...
# Add the 4_Pydantic_AI_Agent directory to the Python path
sys.path.append(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "4_Pydantic_AI_Agent"))
...
# Get the path to the 4_Pydantic_AI_Agent directory with our AI Agent
project_root = Path(__file__).resolve().parent.parent.parent
dotenv_path = project_root / '4_Pydantic_AI_Agent/.env'
